...
import { AriaRouterProvider, MotionProvider } from '@/app/providers';
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className='h-full py-safe px-safe-or-5 dark:bg-black dark:text-white overscroll-none antialiased'>
        <MotionProvider>
